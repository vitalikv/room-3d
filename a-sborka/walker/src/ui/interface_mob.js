    ...
    html +=
		...
		<div style="display: flex; flex-direction: column; position: absolute; bottom: 0; left: 0; right: 0; height: auto; user-select: none;">
			<div nameId="footer_p" style="position: relative; display: flex; justify-content: center; align-items: center; width: 100%; height: 0px;">		
				...
				<div nameId="button_help" class="button_help mobile">
				...
				<div nameId="button_qr" class="button_qr mobile">
				...
				<div nameId="catb_2" class="button_panel mobile">
				...
				<div nameId="catb_1" class="button_panel mobile" style="display: none;">
				...
				<div nameId="catb_3" class="button_panel mobile" style="display: none; width: 110px;">
					<div class="button_panel_img rot90"> 			
						<svg width="13" height="12" viewBox="0 0 13 12" fill="#4A4A4A" xmlns="http://www.w3.org/2000/svg">
							<g>
								${LSVG.getSvg({type: 'button_close_catalog'})}
					...
					<div class="button_panel_txt" style="width: 80px;"> 			
						Скрыть ряд
					</div>			
				</div>				
		...
		<div nameId="help_wrap" class="help_wrap mobile" style="display: none;">
		
			<div nameId="help_info_pc" class="help_info_pc mobile">
				<div class="help_info_pc_bl_1 mobile">
					<img src="${svg_help_info_mobile_1}" style="width: 52px; height: 34px; margin-right: 10px;">
					<div>${lang.help[Build.infProg.doc.language].str1}</div>
				</div>		
			
				<div class="help_info_pc_bl_2 mobile">
					<img src="${svg_help_info_mobile_2}" style="width: 34px; height: 34px; margin-right: 10px;">
		...
		<div nameId="qr_wrap" class="qr_wrap" style="display: none;">
			...
			<div nameId="qr_info" class="qr_info mobile">
		...
		<div nameId="iphone15" class="help_wrap mobile" style="display: none;">
			<div nameId="alert_iphone15" class="alert_iphone15">
				<div class="alert_iphone15_1">
					<img src="${svg_alert}" style="width: 62px; height: 60px; margin-right: 10px;">
					<div>${lang.alertIphone[Build.infProg.doc.language].str1}</div>
				</div>			
			</div>
		</div>		
...
function assignEventEl(params) {
    ...
    el_1.onmousedown = (event) => { el_1.style.display = 'none'; }
    el_2.onmousedown = (event) => { el_1.style.display = 'none'; }
